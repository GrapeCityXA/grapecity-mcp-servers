...
- 查找 GcExcel API、配置项和产品文档
- 根据开发需求获取 Java 或 .NET 代码示例
- 理解电子表格处理和工作簿相关功能
- 排查使用 GcExcel 时遇到的开发问题
- 让 AI 助手结合 GcExcel 官方资料解释解决方案
...
配置完成后，在 MCP 客户端中重载或重启服务，然后直接提问与 GcExcel
...
- GcExcel 机器可读元数据：[server.json](server.json)
